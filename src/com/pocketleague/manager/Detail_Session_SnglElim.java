...
public class Detail_Session_SnglElim extends Detail_Session_Base {
	private static final String LOGTAG = "Detail_Session_SnglElim";
	...
	public void createSessionLayout() {
		...
		bracketHolder = new BracketHolder(sv, s, false) {
			@Override
